...
## install pydeep
    ...
    pip2 uninstall distorm3
    pip2 install distorm3==3.4.4
    pip2 install pefile libpff-python pexpect django geoip2 pycrypto pymongo python-registry virustotal-api yara-python git+https://github.com/smarnach/pyexiftool.git#egg=pyexiftool
